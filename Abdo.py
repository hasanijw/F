...
def chk():
  ...
  try: 
    httpCaht = requests.get("https://pastebin.com/raw/FQNKrkBS").text 
    if id in httpCaht: 
      ...
      print("\033[0;96m   ﻡﺍﺮﻐﻠﻴﺗ ﻪﺘﻌﺑﺍﻭ ﻚﻳﺪﻳﺍ ﺦﺴﻧﺍ  ﻞﻌﻔﻣ ﺮﻴﻏ ﻚﻳﺩ ﻱﺍ d_o_j_w  \033[0;91m#ﻲﻧﺎﺠﻣ ﺲﻴﻟ!!!") 
      os.system('xdg-open  https://t.me/d_o_j_w*')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
